package com.glw.ad.client.controller;

import com.alibaba.fastjson.JSON;
import com.glw.ad.annotation.IgnoreResponseAdvice;
import com.glw.ad.client.SponsorClient;
...
public class SearchController {
    ...
    public CommonResponse<List<AdPlan>> getAdPlansByRibbon(@RequestBody AdPlanGetRequest request) {
        log.info("ad-search: getAdPlansByRibbon -> {}", JSON.toJSONString(request));
        return restTemplate.postForEntity("http://eureka-client-ad-sponsor/ad-sponsor/get/plan", request, CommonResponse.class).getBody();
    }
}
